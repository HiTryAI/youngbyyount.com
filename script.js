...
const CAL_SETS = [
  [ { pillar: 'movement',  icon: 'i-movement',  de: '30 Min. Bewegung',   en: '30 min movement' },
    ...
    { pillar: 'nutrition', icon: 'i-nutrition', de: '1 Portion Obst & Gemüse', en: '1 serving of fruit & veg' } ],
...
const i18n = {
  en: {
    ...
    shot_3_t: '30 science-backed routines',
    ...
    how_2_b:
      'Choose from 30 science-backed routines. Every check earns Young Points – and visibly lowers your number.',
